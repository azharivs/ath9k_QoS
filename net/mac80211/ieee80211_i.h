...
// *** MHDaei-Add ******************************************
/* For using defined data structures in TX Scheduler and
 * calling mac80211_tx_sched_init function
 */
#include "tx-sched.h"
// *** MHDaei-End ******************************************
...
struct ieee80211_local {
	...
	// *** MHDaei-Add ************************************************
	/* @tx_scheduler: Pointer to the main structure of TX Scheduler
	 */
	struct mac80211_tx_scheduler *tx_scheduler;
	// *** MHDaei-End ************************************************
