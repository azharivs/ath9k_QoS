...
void ieee80211_sta_debugfs_add(struct sta_info *sta)
{
	...
	// *** MHDaei-Add ******************************************
	// Defining pointer to the created files
	struct dentry* max_agg_dentry;
	// *** MHDaei-End ******************************************
	...
	// *** MHDaei-Add ******************************************
	// Creating some files
	max_agg_dentry = debugfs_create_u8("set_max_agg",
			S_IRUGO | S_IWUGO,
			sta->debugfs.dir,
			&sta->sta.max_agg);
	// S_IRUGO: Read permission for user, group & others
	// S_IWUGO: Write permission for user, group & others

	if(!max_agg_dentry) {
		printk(KERN_ERR "MHD-Error: Failed to create stations/set_max_agg file.\n");
	}
	...
	// *** MHDaei-Add ******************************************
	tx_scheduler_debugfs_sta_add(sta);
	// *** MHDaei-End ******************************************
}
...
void ieee80211_sta_debugfs_remove(struct sta_info *sta)
{
	...
	// *** MHDaei-Add ******************************************
	tx_scheduler_debugfs_sta_remove(sta);
	// *** MHDaei-End ******************************************
