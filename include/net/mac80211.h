...
struct ieee80211_sta {
	...
	// *** MHDaei-Add ******************************************
	// @max_agg: Maximum number of MPDUs in an A-MPDU
	u8 max_agg;
...
struct ieee80211_ops {
	...
	// *** MHDaei-Add ******************************************
	void (*num_delims) (struct ieee80211_hw *hw,
			bool encrypt, bool first_subfrm,
			unsigned int *num_delims);

	void (*running_tx_process) (struct ieee80211_hw *hw,
			int qnum);
	// *** MHDaei-End ******************************************
};
...
bool mac80211_tx_scheduler_hold_state (struct ieee80211_hw *hw,
		int qnum);
void mac80211_tx_scheduler_finish_status (struct ieee80211_hw *hw,
		int qnum);
